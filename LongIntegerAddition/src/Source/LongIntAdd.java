    ...
    private static String signForSubtraction(String op1, String op2) {
        ...
        if (op1.length() == op2.length()) {
            ...
            for (int indexForSign = 0; indexForSign < op1.length();) {
                ...
                int valueOfOp1 = op1.charAt(indexForSign) - '0';
                int valueOfOp2 = op2.charAt(indexForSign) - '0';
                
                //Checking for Bigger string in value by comparing the digits starting form the MSD
